...
<html>
  ...
  <body>
    ...
    <center>
      <div class="pseudo"> <p> Bonjour <?php echo $_SESSION['pseudo'];?> </p> </div>
      ...
      <div class="tabsModules">
        ...
        <div class="tabs-content">
          <div id="faireC" data-tab-content>
            <div class="box">
              ...
              <div class="cell"> <a href="Capsules/Centres_interets_enfants.php" >
                <img src="images/3D/1_3D.jpg">
                <h4> <p> Centres d'intérêts des enfants </p> </h4>
              </a>
              </div>
          ...
          <div id="quizBienvenue" data-tab-content>
            <div class="box">
              <div class="cell"> <a href="Capsules/Quiz/quiz-question-admin.php" title="Quiz">
                <img src="images/3D/1_3D.jpg">
                <h4> <p> Quiz </p> </h4>
              </a>
              </div>
        ...
        <div class="tabsModules">
          ...
          <div class="tabs-content">
            ...
            <div id="couture" data-tab-content>
              <div class="box">
                <div class="cell"> <a href="">
                  <img src="images/Couture/1Couture.jpg">
                  <h4> <p> Titre </p> </h4>
                </a>
                </div>
      ...
      <div id="tab3" hidden="hidden">
        <div class="tabsModules">
            ...
            <div id="scratch" data-tab-content>
              <div class="box">
                ...
                <div class="cell"> <a href="Capsules/ProgrammerAvecScratch.php">
                  <img src="">
                  <div class="trait"></div>
                  <h4> <p> Programmer avec Scratch </p> </h4>
                </a>
                </div>
          ...
          <div id="cubetto" data-tab-content>
            <div class="box">
              <div class="cell"> <a href="">
                <img src="images/Cubetto/1Cubetto.jpg">
                <div class="trait"></div>
                <h4> <p> Titre </p> </h4>
              </a>
              </div>
        ...
        <div class="tabsModules">
          ...
          <div class="tabs-content">
            ...
            <div id="animerAnniv" data-tab-content>
              <div class="box">
                <div class="cell"> <a href="" >
                  <img src="images/anniversaire.png">
                  <div class="trait"></div>
                  <h4> <p> Titre </p> </h4>
                </a>
                </div>
