...
<html>
  ...
  <head>
      ...
      <title> Atelier exceptionnel | Pause Cocoon </title>
    ...
    <center>
      ...
      <div id="contenu_droite">
        <p class="numlecon"> Leçon 5 sur 9 </p>
        <h2> Qu'est-ce qu'un atelier exceptionnel chez Pause Cocoon </h2>
        <div class="trait"> </div>
        ...
        <div class="choix">
          <div class="lecon_prece">
            <a href="Charte_pause_cocoon.php">  <b> < </b> Leçon précédente </a>
          </div>

          <div class="lecon_suiv">
            <a href="Transmettre.php"> Leçon suivante <b> > </b>  </a>
          </div>
        </div>
