...
<html>
  ...
  <head>
      ...
      <title> Centres d'intérêts | Pause Cocoon </title>
    ...
    <center>
      ...
      <div id="contenu_droite">
        <p class="numlecon"> Leçon 8 sur 9 </p>
        <h2> Les centres d'intérêts des enfants </h2>
        <div class="trait"> </div>
        ...
        <div id="slider">
          ...
          <button class="prew" onclick="prewImage()"> <i class="fas fa-angle-left"></i> </button>
        ...
        <div class="choix">
          ...
          <div class="lecon_prece">
            <a href="Votre_personnalite.php">  <b> < </b> Leçon précédente </a>
          </div>

          <div class="lecon_suiv">
            <a href="Resume.php"> Leçon suivante <b> > </b>  </a>
          </div>
        </div>
