...
<html>
  ...
  <head>
      ...
      <title> Votre personnalité | Pause Cocoon </title>
    ...
    <div id="contenu_droite">
      <p class="numlecon"> Leçon 7 sur 9 </p>
      <h2> Votre personnalité et vos centres d'intérêts </h2>
      <div class="trait"> </div>
      ...
      <div class="choix">
        <div class="lecon_prece">
          <a href="Transmettre.php">  <b> < </b> Leçon précédente </a>
        </div>

        <div class="lecon_suiv">
          <a href="Centres_interets_enfants.php"> Leçon suivante <b> > </b>  </a>
        </div>
      </div>
