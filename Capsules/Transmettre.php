...
<html>
  ...
  <head>
      ...
      <title> Transmettre | Pause Cocoon </title>
    ...
    <center>
      ...
      <div id="contenu_droite">
        <p class="numlecon"> Leçon 6 sur 9 </p>
        <h2> Transmettre avec passion, joie ou sérénité </h2>
        <div class="trait"> </div>
        ...
        <div class="choix">
          ...
          <div class="lecon_prece">
            <a href="Atelier_exceptionnel.php">  <b> < </b> Leçon précédente </a>
          </div>

          <div class="lecon_suiv">
            <a href="Votre_personnalite.php"> Leçon suivante <b> > </b>  </a>
          </div>
        </div>
