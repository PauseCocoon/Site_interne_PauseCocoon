      ...
      <div id="tab2" hidden="hidden">
        <div class="tabsModules">
          <ul class="tabs-title">
            ...
            <li data-tab-target="#sciences" class="tab"> Sciences </a></li>
          </ul>
          ...
          <div class="tabs-content">
            ...
            <div id="sciences" data-tab-content>
        ...
        <div class="tabsModules">
          ...
          <div class="tabs-content">
            ...
            <div id="html" data-tab-content>
              <div class="box">
                <div class="cell"> <a href="Capsules\HTML\tuto1\Video_intro.php">
                    <img src="images/">
                    <div class="trait"></div>
                    <h4>
                      <p> HTML 1 </p>
